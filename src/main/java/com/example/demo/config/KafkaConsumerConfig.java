...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, ToFromStringSerde.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ToFromStringSerde.class);
